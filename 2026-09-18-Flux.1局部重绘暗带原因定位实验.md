...
![局部重绘条件与 KSampler 节点](assets/2026-09-18-flux-inpaint-conditioning-ksampler.png)

但用Flux.fill和Flux.klein实验下来，发现基础的工作流效果并不好。
后来经过在社区的经验收集，又加入了 Inpaint Crop 节点。希望能让模型吃到更多的上下文。

![Inpaint Crop 与 Inpaint Stitch 节点](assets/2026-09-18-inpaint-crop-stitch-nodes.png)
...
在目前的实验中，初步得出的结论是：
1.色带并非来自VAE的色度偏移。
2.Crop/Stich 节点无法消除色带问题。
3.Denoise的增加无法缓解色带问题。
